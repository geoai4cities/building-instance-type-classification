...
Original file is located at
    https://colab.research.google.com/drive/1GAAyDgW7XNlSHDbUO9PMaHG85vq8T_gW
"""
...
# image in this thing
answer_won_dict = dict()
for mapping in [residential_scene_predictions, commercial_scene_predictions, industrial_scene_predictions, others_scene_predictions]:
  for images
  answer_won_dict[image] = np.squeeze(np.asarray(mapping[image]))
